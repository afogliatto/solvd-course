...
//getAverageGrade examples
console.log('getAverageGrade examples');

const students = [
  { name: 'John', grades: [80, 90, 75] },
  { name: 'Jane', grades: [85, 95, 70] },
  { name: 'Alice', grades: [75, 85, 80] },
];

console.log(task2.getAverageGrade(students));
